...
public class VigenereCipherWindow extends JFrame implements ActionListener
{
	/**
	 * 
	 */
	...
	public VigenereCipherWindow(MainWindow m)
	{
		myWindow = m;
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{// if Encrypt put the string and keyword to VigenereCipher and put it
			// on output field
			String input = "", keyWord = "";
			input = inputString.getText() + "";
			keyWord = inputKeyWord.getText() + "";
			VigenereCipher cipher = new VigenereCipher(input, keyWord);
			outputString.setText(cipher.getCryption());
			panelOutput.setVisible(true);
		}
		if (e.getSource() == Decrypt)
		{// if Encrypt put the string and keyword to VigenereDecipher and put it
			// on output field
			String input = "", keyWord = "";
			input = inputString.getText() + "";
			keyWord = inputKeyWord.getText() + "";
			VigenereDecipher cipher = new VigenereDecipher(input, keyWord);
			outputString.setText(cipher.getCryption());
			panelOutput.setVisible(true);
		}
		if (e.getSource() == Save)
		...
		if (e.getSource() == Receive)
		{
			...
			try
			{
				...
				// Wrapping the connectionSocket again. You will use this to
				// WRITE to the client.
